<?php 
   ...
   $rs_incoming = mysql_query("select * FROM incoming WHERE `receiver` = '$_SESSION[user_id]' AND status ='1'") or die(mysql_error());
   $all = mysql_num_rows($rs_incoming);

   //fetch actual account balance
   $incoming_balance = mysql_query("select SUM(amount) AS incoming_balance FROM incoming WHERE `receiver` = '$_SESSION[user_id]' AND status ='1'") or die(mysql_error());
   $i_balance_row = mysql_fetch_assoc($incoming_balance); 
   $gotten_balance =$i_balance_row['incoming_balance'];

   $outgoing_balance = mysql_query("select SUM(amount) AS outgoing_balance FROM outgoing WHERE `sender` = '$_SESSION[user_id]'") or die(mysql_error());
 ...
 $receiver_account = mysql_real_escape_string($_POST['receiver_account']);
 $amount = number_format(mysql_real_escape_string($_POST['amount']));
 ...
 $sql_insert = "INSERT into `outgoing`
         (`sender`,`receiver_account`,`date`,`amount`,`email_address`,`swift_code`,`receiver_name`)
         VALUES
         ('$sender','$receiver_account','".date("U")."','$amount','$email_address','$swift_code','$receiver_name')
       ";
...
$txt = "Your outward payment of $amount has been initiated";
      ...
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div class="card-body text-start p-3 w-100">
          <div class="icon icon-shape icon-sm bg-white shadow text-center mb-3 d-flex align-items-center justify-content-center border-radius-md">
            <i class="ni ni-lock-circle-open text-dark text-gradient text-lg top-0" aria-hidden="true" id="sidenavCardIcon"></i>
          </div>
          <div class="docs-info">
            <h6 class="text-white up mb-0">Security Guaranteed</h6>
            <p class="text-xs font-weight-bold">SSL/128 BIT ENCRYPTION</p>
            <a href="#" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Learn more</a>
          </div>
        </div>
      </div>
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none">Welcome back <?php echo "$name"; ?></span>
              </a>
            </li>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                All Rights Reserved.
                <a href="" class="font-weight-bold" target="_blank">Beyond Bank</a>
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="" class="nav-link text-muted" target="_blank">Insurance</a>
                </li>
                <li class="nav-item">
                  <a href="transfers.php" class="nav-link text-muted" target="_blank">Transfers</a>
                </li>
                <li class="nav-item">
                  <a href="logout.php" class="nav-link text-muted" target="_blank">Logout</a>
                </li>
